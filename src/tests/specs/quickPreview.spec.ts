...
describe('planner quick preview tests', () => {
  ...
  it('description box should not be open for wis',async () =>{
    ...
    expect(await planner.quickPreview.descriptionSaveButton.isDisplayed()).toBeTruthy();
    ...
    expect(await planner.quickPreview.descriptionSaveButton.isDisplayed()).toBeFalsy();
  })
});
