...
export class WorkItemDetailPage {
  ...
  setWorkItemDetailTitle(newTitleString, append) {
    if (!append) { 
      this.workItemDetailTitle.clear() 
    };
  ...
  clickWorkItemTitleSaveIcon() {
    browser.wait(this.until.elementToBeClickable(this.workItemTitleSaveIcon));
  ...
  setWorkItemDetailDescription(newDescriptionString, append) {
    if (!append) { 
      this.workItemDetailDescriptionValue.clear();
    };
  ...
  clickWorkItemDescriptionCancelIcon() {
    this.testSupport.clickElement(this.workItemDescriptionCancelIcon, "workItemDescriptionCancelIcon", "WorkItemDetailPage");
    return;
  }
  ...
  */
  ...
  /**UI elements for comments this.testSupport  */
  clickCommentsDiv() {
  ...
  clickCommentIcon() {
    browser.wait(this.until.presenceOf(this.commentIcon), this.constants.WAIT, 'Failed to find element commentIcon');
  ...
  clickActiveCommentEditorBox() {
    this.testSupport.clickElement(this.activeCommentEditorBox, "activeCommentEditorBox", "WorkItemDetailPage");
    return;
  }
  ...
  editComments(comment, index, append) {
    if (!append) { this.commentBody(index).clear() };
  ...
  clickCommentSaveButton() {
    this.testSupport.clickElement(this.commentSaveButton, "commentSaveButton", "WorkItemDetailPage");
    return;
  }
  ...
  clickCommentSaveCancelButton() {
    this.testSupport.clickElement(this.commentSaveCancelButton, "commentSaveCancelButton", "WorkItemDetailPage");
    return;
  }
  ...
  commentEdit(index) {
    browser.wait(this.until.presenceOf(element(by.css('#comment_body_' + index))))
  ...
  commentBody(index) {
    browser.wait(this.until.presenceOf(element(by.css('#comment_body_' + index + ' .editor-box'))))
  ...
  get searchLinkItemTextBox() {
    this.clickSearchLinkItemTextBox();
    return element(by.id("workitem-link-search"));
  }
  ...
  searchAreaInput(AreaInput) {
    element(by.id("areaSearchInput")).click();
    return element(by.id("areaSearchInput")).sendKeys(AreaInput);
  }
  clickAreas(areaid) {
  ...
  IterationOndetailPage() {
    browser.wait(this.until.elementToBeClickable(element(by.css('#iteration-dropdown .details-dropdown'))), this.constants.WAIT, 'Failed to find iteration on detail page');
  ...
  clickStepsToReproduceText() {
    browser.wait(this.until.visibilityOf(this.stepsToReproduceText));
  ...
  setstepsToReproduceText(newString) {
    browser.wait(this.until.visibilityOf(this.editableTextForStepsToReproduce));
  ...
  setStoryPointsText(newString) {
    browser.wait(this.until.visibilityOf(this.storyPoints));
  ...
  clickDueDateSelection() {
    browser.wait(this.until.elementToBeClickable(this.dueDateSelection));
  ...
  clickSeverityDropdown() {
    browser.wait(this.until.elementToBeClickable(this.severityDropdown));
  ...
  getLabelByTitle(title) {
    browser.wait(this.until.elementToBeClickable(element(by.xpath("//ul[@class='select-dropdown-menu']/li//*[text()='" + title + "']"))));
