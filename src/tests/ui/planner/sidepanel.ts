...
export class SidePanel extends ui.BaseElement {
  showHideSidePanelButton = new ui.Button(this.$('.f8-planner-sidepanel__toggle-icon'), 'show/hide side panel button');
  ...
  deleteCustomQuery = new ui.Clickable(this.element(by.cssContainingText('.f8-planner-custom-query__list .dropdown.open ul>li', 'Delete')), 'Custom query Dropdown Delete Option');
