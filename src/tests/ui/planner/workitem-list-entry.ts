...
export class WorkItemListEntry extends ui.BaseElement {
  ...
  inlineQuickAdd = new ui.Clickable(this.$('.f8-planner__quick-add-icon'), 'Inline quick add button');
  ...
  title = new ui.Clickable(this.$('.f8-planner-cell__title p'), 'WorkItem Title');
  ...
  labelName =  new ui.Clickable(this.element(by.cssContainingText('.f8-label-name', 'sample_label_1')), 'WorkItem Label');
