    ...
    get(url: string, options?: RequestOptionsArgs): Observable<Response> {
      ...
      switch (path.path) {
        ...
        case '/workitems':
          ...
          } else if (path.params['filter[assignee]'] || path.params['filter[workitemtype]'] || path.params['filter[workitemstate]'] || path.params['filter[iteration]'] || path.params['filter[area]' || path.params['filter[creator]']]) {
