...
mkdir -p runtime/dist && docker run --detach=true --name=fabric8-ui-builder -e "API_URL=http://api.openshift.io/api/" -t -v $(pwd)/runtime/dist:/dist:Z fabric8-ui-builder
